 ...
 */
public class OverviewContentTextView extends TextView {

    public OverviewContentTextView(Context context) {
        super(context);
        applyCustomFont(context);
    }

    public OverviewContentTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        applyCustomFont(context);
    }

    public OverviewContentTextView(Context context, AttributeSet attrs, int defStyle) {
