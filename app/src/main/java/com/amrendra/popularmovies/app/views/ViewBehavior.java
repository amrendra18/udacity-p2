...
public class ViewBehavior extends CoordinatorLayout.Behavior<TitleTaglineView> {
    ...
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, TitleTaglineView child, View dependency) {
        return dependency instanceof AppBarLayout;
    }

    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, TitleTaglineView child, View dependency) {
    ...
    private void shouldInitProperties(TitleTaglineView child, View dependency) {
    ...
    public int getToolbarHeight() {
        ...
        if (mContext.getTheme().resolveAttribute(R.dimen.toolbar_height, tv, true)) {
